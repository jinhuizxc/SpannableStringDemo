...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spannableString02.setSpan(underlineSpan02, spannableString02.length() - 5, spannableString02.length() - 3, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ForegroundColorSpan colorSpan021 = new ForegroundColorSpan(Color.parseColor("#0099FF"));
        spannableString02.setSpan(colorSpan021, spannableString02.length() - 5, spannableString02.length() - 3, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        stringBuffer.append("这本书价格 ");
        stringBuffer.append(string04);
        stringBuffer.append(" 元");
        SpannableString spannableString04 = new SpannableString(stringBuffer);
        StrikethroughSpan strikethroughSpan = new StrikethroughSpan();
        spannableString04.setSpan(strikethroughSpan, 6, spannableString04.length() - 2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//            super.updateDrawState(ds);  // 注释掉这一行，否则设置的字的颜色位红色；
